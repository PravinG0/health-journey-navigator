    ...
    >
      <defs>
        <linearGradient id="rmc-ring" x1="0" y1="0" x2="1" y2="1">
          ...
          <stop offset="100%" stopColor="var(--accent-strong)" stopOpacity="0.15" />
        </linearGradient>
      </defs>
      <g
        className="rmc-orbit"
      ...
      >
        <circle
          ...
          strokeWidth="1"
        />
        <circle cx="200" cy={70 - index * 8} r="4" fill="var(--accent-strong)" opacity="0.5" />
      </g>
      <g
    ...
    >
      ...
      <div className="relative mx-auto max-w-6xl px-6">
        <header className="max-w-2xl">
          <p className="rmc-item text-[0.7rem] font-semibold uppercase tracking-[0.32em] text-accent-strong">
          ...
          >
            A Personalized Path to <span className="italic text-accent-strong">Better Health</span>
          </h2>
          ...
          {programs.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  <span className="mr-2 text-xs tabular-nums text-accent-strong/70">
                    {item.number}
                  </span>
                  {item.nav}
                </span>
                <span
                  aria-hidden="true"
                  className="absolute inset-x-0 -bottom-px h-px origin-left bg-accent-strong transition-transform duration-500 ease-out"
        ...
        >
          <div key={`copy-${program.id}`} className="rmc-swap order-2 lg:order-1">
            <p className="text-[0.7rem] font-semibold uppercase tracking-[0.3em] text-muted-foreground">
              <span className="text-accent-strong">{program.number}</span> — {program.eyebrow}
            </p>
            ...
            <a
              href={program.href}
              className="group mt-8 inline-flex items-center gap-3 rounded-full border border-accent-strong/30 px-6 py-3 text-sm font-medium text-foreground transition-all duration-500 hover:border-accent-strong hover:bg-accent-strong/8 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
            >
              {program.cta}
              <span
                aria-hidden="true"
